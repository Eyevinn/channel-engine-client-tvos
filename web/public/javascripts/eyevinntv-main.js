...
function replaceLoadingPageWithChannelSelectionPage(channelSelectionPageTemplate) {
    ...
    // console.log('after', channelSelectionPageTemplate, channelSelectionPage)
...
function updateBackgroundImage(channelName) {
    console.log('will update background image with channel ', channelName, getFirstDocumentInStack().getElementById('background-images'), navigationDocument.documents.length);
